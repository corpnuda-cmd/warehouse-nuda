-- ============================================================
-- Warehouse Management System - SQLite Seed Data
-- ============================================================
...
('admin', 'admin@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Administrator', 'super_admin', 1),
('manager', 'manager@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Manager Gudang', 'admin', 1),
('purchasing', 'purchasing@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Staff Purchasing', 'purchasing', 1),
('gudang', 'gudang@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Staff Gudang', 'gudang', 1),
('store01', 'store01@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Store Jakarta', 'store_user', 1),
('finance', 'finance@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Staff Finance', 'finance', 1),
('auditor', 'auditor@warehouse.com', '$2a$10$8K1p/a0dL3.HKwHkqhIW4u7ELKPLs6eEHqKr2jB7LRxYqH.aNqm2q', 'Internal Auditor', 'auditor', 1);
...
-- INSERT WAREHOUSES
INSERT INTO warehouses (code, name, address, type, is_active) VALUES
('WH-MAIN', 'Gudang Utama Jakarta', 'Jl. Industri Raya No. 123, Jakarta Timur', 'main', 1),
('WH-DIST-JKT', 'Gudang Distribusi Jakarta', 'Jl.港口 Raya No. 45, Jakarta Utara', 'distribution', 1),
('WH-DIST-BDG', 'Gudang Distribusi Bandung', 'Jl. Pasteur No. 78, Bandung', 'distribution', 1),
('WH-DIST-SBY', 'Gudang Distribusi Surabaya', 'Jl. Margomulyo No. 56, Surabaya', 'distribution', 1),
('STORE-JKT-01', 'Toko Jakarta 01', 'Jl. Sudirman No. 100, Jakarta Pusat', 'store', 1),
('STORE-JKT-02', 'Toko Jakarta 02', 'Jl. Thamrin No. 50, Jakarta Pusat', 'store', 1),
('STORE-BDG-01', 'Toko Bandung 01', 'Jl. Braga No. 25, Bandung', 'store', 1);
...
('SUP-001', 'PT. Sumber Makmur', 'Budi Santoso', 'budi@sumbermakmur.co.id', '021-1234567', 'Jl. Merdeka No. 10, Jakarta', 1),
('SUP-002', 'CV. Jaya Abadi', 'Siti Rahayu', 'siti@jayaabadi.com', '021-2345678', 'Jl. Pangeran Diponegoro No. 25, Bandung', 1),
('SUP-003', 'PT. Indo Supply', 'Ahmad Wijaya', 'ahmad@indosupply.id', '031-3456789', 'Jl. Pemuda No. 40, Surabaya', 1),
('SUP-004', 'Toko Electronics Grosir', 'Diana Putri', 'diana@electgrosir.com', '021-4567890', 'Jl. Mangga Besar No. 88, Jakarta', 1),
('SUP-005', 'PT. Safety First', 'Rudi Hermawan', 'rudi@safetyfirst.co.id', '022-5678901', 'Jl. Asia Afrika No. 15, Bandung', 1);

-- INSERT ITEMS
INSERT INTO items (code, name, category_id, uom_id, min_stock, reorder_point, price, barcode, description, is_active) VALUES
('ITEM-001', 'Laptop ASUS VivoBook 15', 1, 1, 5, 10, 7500000, '8901234567890', 'Laptop 15 inch Intel Core i5', 1),
('ITEM-002', 'Mouse Wireless Logitech', 1, 1, 20, 50, 150000, '8901234567891', 'Mouse wireless USB', 1),
('ITEM-003', 'Keyboard Mechanical RGB', 1, 1, 15, 30, 450000, '8901234567892', 'Keyboard mechanical gaming', 1),
('ITEM-004', 'Monitor LG 24 inch', 1, 1, 10, 20, 2500000, '8901234567893', 'Monitor LED Full HD', 1),
('ITEM-005', 'Kertas A4 Double Folio', 2, 3, 100, 200, 35000, '8901234567894', 'Kertas A4 80gsm 500 lembar', 1),
('ITEM-006', 'Ballpoint Pilot G2', 2, 1, 50, 100, 5000, '8901234567895', 'Ballpoint hitam 0.7mm', 1),
('ITEM-007', 'Map File Folder', 2, 1, 30, 60, 8000, '8901234567896', 'Map folder plastik A4', 1),
('ITEM-008', 'Stapler Big', 2, 1, 20, 40, 25000, '8901234567897', 'Stapler besar kapasitas 50 lembar', 1),
('ITEM-009', 'Meja Kerja Standard', 3, 1, 5, 10, 1500000, '8901234567898', 'Meja kerja 120x60x75cm', 1),
('ITEM-010', 'Kursi Kantor Ergonomis', 3, 1, 5, 15, 850000, '8901234567899', 'Kursi kantor dengan armrest', 1),
('ITEM-011', 'Safety Helmet', 6, 1, 20, 50, 75000, '8901234567900', 'Helm safety warna kuning', 1),
('ITEM-012', 'Safety Gloves', 6, 3, 30, 60, 45000, '8901234567901', 'Sarung tangan safety ukuran L', 1),
('ITEM-013', 'Safety Shoes', 6, 1, 15, 30, 350000, '8901234567902', 'Sepatu safety size 42', 1),
('ITEM-014', 'Obat-obat P3K', 10, 1, 10, 20, 125000, '8901234567903', 'Kit P3K lengkap', 1),
('ITEM-015', 'Sabun Cuci Tangan', 8, 2, 20, 40, 25000, '8901234567904', 'Sabun cair 500ml', 1);
